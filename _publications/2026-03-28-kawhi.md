...
citation: 'Yuhang Han, Yuyang Wu, Zhengbo Jiao, Yiyu Wang, Xuyang Liu, Shaobo Wang, Hanlin Xu, Xuming Hu, and Linfeng Zhang. (2026). &quot;Bridging Visual Representation and Reinforcement Learning from Verifiable Rewards in Large Vision-Language Models.&quot; <i>Proceedings of the European Conference on Computer Vision (ECCV)</i>.'
bibtex: |
  @inproceedings{han2026kawhi,
    title={Bridging Visual Representation and Reinforcement Learning from Verifiable Rewards in Large Vision-Language Models},
