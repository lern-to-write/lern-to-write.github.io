...
.p-card {
  ...
  box-shadow:
    0 0 0 1px rgba(60,40,20,0.02),
    0 1px 3px rgba(60,40,20,0.04),
    0 4px 12px rgba(60,40,20,0.03),
    0 12px 32px rgba(60,40,20,0.02);
...
.p-card:hover {
  box-shadow:
    0 0 0 1px rgba(60,40,20,0.03),
    0 2px 8px rgba(60,40,20,0.05),
    0 8px 24px rgba(60,40,20,0.04),
    0 24px 48px rgba(60,40,20,0.03);
...
.hero-card::before {
  ...
  background: linear-gradient(90deg, #c4633d, #d4754e, #e08a6a);
  border-radius: 20px 20px 0 0;
}
.hero-card::after {
  content: ''; position: absolute; top: -60px; right: -60px;
  width: 200px; height: 200px;
  background: radial-gradient(circle, rgba(196,99,61,0.06) 0%, transparent 70%);
  border-radius: 50%; pointer-events: none;
}
.hero-name {
  font-size: 2.2em; font-weight: 900; color: #1c1917;
  letter-spacing: -0.04em; line-height: 1.1; margin: 0 0 10px;
  position: relative; z-index: 1;
}
.hero-name .wave { font-size: 0.7em; margin-left: 4px; }
.hero-tagline {
  font-size: 1.15em; color: #c4633d; font-weight: 600;
  margin: 0 0 18px; position: relative; z-index: 1;
  letter-spacing: -0.01em;
}
.hero-bio {
  font-size: 0.96em; color: #57534e; line-height: 1.85;
  max-width: 700px; position: relative; z-index: 1;
}
.hero-bio a {
  color: #1c1917; text-decoration: none; font-weight: 600;
  background-image: linear-gradient(transparent 85%, rgba(196,99,61,0.2) 85%);
  background-repeat: no-repeat; background-size: 100% 100%;
  transition: background-size 0.3s, color 0.2s;
}
.hero-bio a:hover { color: #c4633d; background-image: linear-gradient(transparent 82%, rgba(196,99,61,0.3) 82%); }
...
.hero-pill:hover {
  ...
  box-shadow: 0 6px 18px rgba(60,40,20,0.2);
}
.hero-pill.hp-accent { background: linear-gradient(135deg, #c4633d, #d4754e); }
.hero-pill.hp-accent2 { background: linear-gradient(135deg, #a16207, #ca8a04); }
.hero-pill.hp-accent3 { background: linear-gradient(135deg, #166534, #22c55e); }
...
.r-pill .r-text strong { display: block; font-size: 0.98em; margin-bottom: 3px; color: #1c1917; }
.r-pill .r-text span { font-size: 0.8em; color: #78716c; font-weight: 400; }

.rp-streaming .r-icon-wrap { background: linear-gradient(135deg, #fef2f2, #fecaca); color: #dc2626; }
.rp-compression .r-icon-wrap { background: linear-gradient(135deg, #eff6ff, #bfdbfe); color: #2563eb; }
.rp-datacentric .r-icon-wrap { background: linear-gradient(135deg, #f0fdf4, #bbf7d0); color: #16a34a; }
...
.stat-card:nth-child(1) .stat-icon-wrap { background: linear-gradient(135deg, #fef3c7, #fde68a); }
...
.stat-num {
  font-size: 2.8em; font-weight: 900; color: #1c1917;
  display: block; letter-spacing: -0.04em; line-height: 1;
  font-family: 'JetBrains Mono', 'Fira Code', monospace;
}
.stat-label {
  font-size: 0.72em; color: #a8a29e; text-transform: uppercase;
  letter-spacing: 0.18em; font-weight: 700; margin-top: 10px; display: block;
}

/* --- Section Title --- */
.sec-title {
  font-size: 1.5em; font-weight: 800; color: #1c1917;
  margin: 40px 0 24px;
...
.sec-title .sec-icon {
  ...
  background: linear-gradient(135deg, #c4633d, #d4754e);
  color: #fff;
  display: inline-flex; align-items: center; justify-content: center;
  font-size: 1.1em;
  box-shadow: 0 4px 14px rgba(196,99,61,0.3);
}
.sec-title::after {
  content: ''; flex: 1; height: 2px;
  background: linear-gradient(90deg, rgba(196,99,61,0.12) 0%, transparent 100%);
  border-radius: 1px;
}
...
.divider {
  ...
  background: linear-gradient(90deg, transparent, rgba(60,40,20,0.06) 20%, rgba(60,40,20,0.06) 80%, transparent);
}
...
.timeline-wrap::before {
  ...
  width: 3px;
  background: linear-gradient(180deg, #c4633d 0%, #d4754e 50%, rgba(196,99,61,0.08) 100%);
  border-radius: 3px;
}
.tl-item {
  position: relative;
...
.tl-item::before {
  ...
  background: #fff; border: 3px solid #d4754e;
  box-shadow: 0 0 0 5px rgba(196,99,61,0.1);
  z-index: 1; transition: all 0.3s cubic-bezier(0.34,1.56,0.64,1);
}
.tl-item:hover::before {
  background: #c4633d; border-color: #c4633d;
  box-shadow: 0 0 0 8px rgba(196,99,61,0.12);
  transform: scale(1.3);
}
...
.tl-item em { color: #44403c; font-style: normal; font-weight: 500; }
.tl-item strong { color: #1c1917; }
...
/* --- Sub Heading --- */
.sub-h {
  font-size: 1.1em; font-weight: 700; color: #1c1917;
...
.paper-card::before {
  ...
  width: 100% !important;
  background: var(--accent, #c4633d);
  border-radius: 20px 20px 0 0;
}
.paper-card h4 { margin: 0 0 10px; font-size: 1.08em; line-height: 1.45; font-weight: 700; color: #1c1917; padding-right: 110px; }
.paper-card h4 a { color: inherit; text-decoration: none; border-bottom: none; transition: color 0.2s; }
.paper-card h4 a:hover { color: #c4633d; }

.p-authors { font-size: 0.85em; color: #78716c; margin-bottom: 10px; line-height: 1.6; }
.p-authors strong { color: #44403c; font-weight: 600; }
...
.v-badge {
  ...
  margin-bottom: 12px;
  color: var(--accent, #c4633d);
  background: var(--accent-bg, rgba(196,99,61,0.06));
  border: 1px solid var(--accent-border, rgba(196,99,61,0.1));
}

.p-desc { font-size: 0.88em; color: #78716c; line-height: 1.75; margin-bottom: 16px; }
.p-desc strong { color: #44403c; font-weight: 600; }
...
.p-links img:hover { transform: translateY(-3px) scale(1.05); box-shadow: 0 6px 16px rgba(60,40,20,0.12); }
...
.cite-toggle {
  ...
  color: #57534e; background: rgba(60,40,20,0.04);
...
.cite-row-label {
  font-size: 0.7em; font-weight: 700; color: #1c1917;
...
.cite-row-label button {
  ...
  font-size: 0.85em; font-weight: 600; color: #44403c;
  cursor: pointer; transition: all 0.2s;
}
.cite-row-label button:hover { background: #1c1917; color: #fff; }
.cite-row-label button.copied { background: #16a34a; color: #fff; border-color: #16a34a; }
.cite-text, .cite-pre {
  font-family: 'JetBrains Mono', 'Fira Code', monospace;
  font-size: 0.78em; line-height: 1.6; color: #57534e;
}
.cite-pre { margin: 0; white-space: pre-wrap; word-break: break-word; }

.note-text { font-size: 0.84em; color: #a8a29e; margin-bottom: 18px; font-style: italic; }
.note-text a { color: #c4633d; font-weight: 600; text-decoration: none; }
...
.view-all-btn:hover {
  ...
  box-shadow:
    ...
    0 16px 40px rgba(60,40,20,0.05);
  background: #1c1917; color: #fff;
}
...
.svc-card {
  ...
  font-size: 0.94em; color: #57534e; line-height: 1.7;
}
.svc-card .svc-icon {
  ...
  box-shadow: 0 6px 18px rgba(196,99,61,0.3);
  color: #fff;
}
.svc-card strong { color: #1c1917; }
.v-tags { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; }
.v-tag {
  font-size: 0.74em; padding: 3px 12px; border-radius: 6px;
  font-weight: 600; letter-spacing: 0.03em;
  background: rgba(60,40,20,0.05); color: #44403c;
  transition: all 0.25s;
}
.v-tag:hover { background: #1c1917; color: #fff; }
...
<div class="hero-card p-card reveal">
  ...
  <div class="hero-pills">
    ...
    <span class="hero-pill hp-accent">🏫 SJTU</span>
    <span class="hero-pill hp-accent2">💼 Tencent</span>
    <span class="hero-pill hp-accent">🎥 Streaming</span>
    <span class="hero-pill hp-accent3">⚡ Efficient VideoLLM</span>
  </div>
</div>
