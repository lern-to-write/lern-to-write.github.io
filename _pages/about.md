...
<div style="background-color: #f3f6f9; border-radius: 8px; padding: 20px; border-left: 5px solid #003366; margin-bottom: 25px;">
  <h3 style="margin-top: 0; color: #003366;">🚀 Efficient Video Understanding & Generation</h3>
...
<div style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.1); transition: 0.3s; border-radius: 5px; padding: 20px; margin-bottom: 20px; border-left: 5px solid #db545a; background-color: #fff;">
  ...
  <p style="font-size: 0.95em; color: #555;">
    Proposed <strong>VidCom²</strong>, a training-free framework that accelerates VideoLLMs by adaptively adjusting compression based on frame uniqueness. Achieved <strong>99.6% performance retention</strong> with only <strong>25% tokens</strong>.
  </p>
  <div>
...
* [cite_start]**[Awesome Token-level Model Compression](https://github.com/your-username/repo1)** (⭐ 173+) [cite: 42]
* [cite_start]**[Awesome Generation Acceleration](https://github.com/your-username/repo2)** (⭐ 353+) [cite: 43]
